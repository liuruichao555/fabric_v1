...
public class GossipGrpc {
  ...
  public static final io.grpc.MethodDescriptor<gossip.Message.Envelope,
      ...
      io.grpc.MethodDescriptor.create(
          ...
          io.grpc.protobuf.ProtoUtils.marshaller(gossip.Message.Envelope.getDefaultInstance()),
          io.grpc.protobuf.ProtoUtils.marshaller(gossip.Message.Envelope.getDefaultInstance()));
  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static final io.grpc.MethodDescriptor<gossip.Message.Empty,
      ...
      io.grpc.MethodDescriptor.create(
          ...
          generateFullMethodName(
              "gossip.Gossip", "Ping"),
          io.grpc.protobuf.ProtoUtils.marshaller(gossip.Message.Empty.getDefaultInstance()),
          io.grpc.protobuf.ProtoUtils.marshaller(gossip.Message.Empty.getDefaultInstance()));
  ...
  private static class MethodHandlers<Req, Resp> implements
    ...
    public MethodHandlers(GossipImplBase serviceImpl, int methodId) {
