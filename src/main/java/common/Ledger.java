...
public final class Ledger {
  ...
  public  static final class BlockchainInfo extends
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return common.Ledger.internal_static_common_BlockchainInfo_descriptor;
    }

    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return common.Ledger.internal_static_common_BlockchainInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              common.Ledger.BlockchainInfo.class, common.Ledger.BlockchainInfo.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof common.Ledger.BlockchainInfo)) {
        return super.equals(obj);
      }
      common.Ledger.BlockchainInfo other = (common.Ledger.BlockchainInfo) obj;
    ...
    public static common.Ledger.BlockchainInfo parseFrom(
    ...
    public static common.Ledger.BlockchainInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static common.Ledger.BlockchainInfo parseFrom(
    ...
    public static common.Ledger.BlockchainInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static common.Ledger.BlockchainInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static common.Ledger.BlockchainInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(common.Ledger.BlockchainInfo prototype) {
    ...
    public static final class Builder extends
        ...
        common.Ledger.BlockchainInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return common.Ledger.internal_static_common_BlockchainInfo_descriptor;
      }
      ...
      // Construct using common.Ledger.BlockchainInfo.newBuilder()
      private Builder() {
      ...
      public common.Ledger.BlockchainInfo getDefaultInstanceForType() {
        return common.Ledger.BlockchainInfo.getDefaultInstance();
      }

      public common.Ledger.BlockchainInfo build() {
        common.Ledger.BlockchainInfo result = buildPartial();
      ...
      public common.Ledger.BlockchainInfo buildPartial() {
        common.Ledger.BlockchainInfo result = new common.Ledger.BlockchainInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof common.Ledger.BlockchainInfo) {
          return mergeFrom((common.Ledger.BlockchainInfo)other);
        } else {
      ...
      public Builder mergeFrom(common.Ledger.BlockchainInfo other) {
        if (other == common.Ledger.BlockchainInfo.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        common.Ledger.BlockchainInfo parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (common.Ledger.BlockchainInfo) e.getUnfinishedMessage();
    ...
    private static final common.Ledger.BlockchainInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new common.Ledger.BlockchainInfo();
    }

    public static common.Ledger.BlockchainInfo getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "ash\030\002 \001(\014\022\031\n\021previousBlockHash\030\003 \001(\014B-Z+" +
      "github.com/hyperledger/fabric/protos/com" +
      "monb\006proto3"
    };
